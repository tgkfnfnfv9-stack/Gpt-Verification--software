"""Archived M15 preliminary screen. Audit/reproduction only; do not use for formal OANDA validation."""
...
def main():
    ...
    for sym in symbols:
        try:
            base=load_pair(sym)
            results.append(cell(sym,'M15',base))
